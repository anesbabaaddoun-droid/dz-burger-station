          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#E5E7EB] bg-[#F9FAFB]">
                <th className="text-left px-5 py-3.5 text-xs font-semibold uppercase tracking-wider text-[#6B7280]">Call ID</th>
                <th className="text-left px-5 py-3.5 text-xs font-semibold uppercase tracking-wider text-[#6B7280]">Customer Name</th>
                ...
                <th className="text-left px-5 py-3.5 text-xs font-semibold uppercase tracking-wider text-[#6B7280]">Duration</th>
              ...
              {filteredCalls.length > 0 ? (
                filteredCalls.map((call) => (
                  <tr key={call.id} className="hover:bg-[#FAFAFA] transition-colors">
                    ...
                    <td className="px-5 py-4">
                      <p className="font-semibold text-[#111827]">{call.customer}</p>
                    ...
                    <td className="px-5 py-4 text-[#374151]">{call.duration}</td>
                    <td className="px-5 py-4">
                      <StatusBadge status={call.status} />
                    </td>
